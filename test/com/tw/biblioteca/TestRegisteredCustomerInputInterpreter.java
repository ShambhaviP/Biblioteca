...
public class TestRegisteredCustomerInputInterpreter {
    ...
    @Test
    public void shouldDisplayUserProfileWhenARegisteredCustomerChoosesOptionNumberSix() {
        ArrayList<Book> availableBooks = new ArrayList<>();
        Book book = new Book("Dracula", "Bram Stoker", 1920);
        availableBooks.add(book);
        ArrayList<Book> checkedOutBooks = new ArrayList<>();
    ...
    @Test
    public void shouldPerformASystemExitWhenRegisteredCustomerChoosesOptionNumberEightToQuitApplication() {
        Book book = new Book("Dracula", "Bram Stoker", 1920);
        ArrayList<Book> availableBooks = new ArrayList<>();
        availableBooks.add(book);
        ArrayList<Book> checkedOutBooks = new ArrayList<>();
        ...
        registeredCustomerInputInterpreter.interpret("8");
    }
